...
.method private httpDo(Lorg/apache/http/client/methods/HttpUriRequest;Ljava/lang/String;Lcom/androidquery/callback/AjaxStatus;)V
    ...
    invoke-virtual {v2, v7, v1, v8}, Lcom/androidquery/callback/ProxyHandle;->applyProxy(Lcom/androidquery/callback/AbstractAjaxCallback;Lorg/apache/http/HttpRequest;Lorg/apache/http/impl/client/DefaultHttpClient;)V
    ...
    :cond_2
    :goto_0
    iget-object v2, v7, Lcom/androidquery/callback/AbstractAjaxCallback;->headers:Ljava/util/Map;
    ...
    .line 1665
    :cond_6
    iget-object v2, v7, Lcom/androidquery/callback/AbstractAjaxCallback;->ah:Lcom/androidquery/auth/AccountHandle;
    ...
    invoke-virtual {v2, v7, v1}, Lcom/androidquery/auth/AccountHandle;->applyToken(Lcom/androidquery/callback/AbstractAjaxCallback;Lorg/apache/http/HttpRequest;)V
    ...
    .line 1671
    invoke-interface {v1, v3, v2}, Lorg/apache/http/client/methods/HttpUriRequest;->addHeader(Ljava/lang/String;Ljava/lang/String;)V
    ...
    .line 1679
    iget-object v3, v7, Lcom/androidquery/callback/AbstractAjaxCallback;->proxy:Lorg/apache/http/HttpHost;

    if-eqz v3, :cond_9

    const-string v3, "http.route.default-proxy"

    iget-object v4, v7, Lcom/androidquery/callback/AbstractAjaxCallback;->proxy:Lorg/apache/http/HttpHost;
    ...
    .line 1683
    iget v4, v7, Lcom/androidquery/callback/AbstractAjaxCallback;->timeout:I
    ...
    .line 1687
    :cond_a
    iget-boolean v3, v7, Lcom/androidquery/callback/AbstractAjaxCallback;->redirect:Z
    ...
    .line 1693
    invoke-interface {v9, v4, v3}, Lorg/apache/http/protocol/HttpContext;->setAttribute(Ljava/lang/String;Ljava/lang/Object;)V

    .line 1695
    iput-object v1, v7, Lcom/androidquery/callback/AbstractAjaxCallback;->request:Lorg/apache/http/client/methods/HttpUriRequest;

    .line 1697
    iget-boolean v3, v7, Lcom/androidquery/callback/AbstractAjaxCallback;->abort:Z
    ...
    .line 1715
    invoke-interface {v2, v3, v10}, Lorg/apache/http/params/HttpParams;->setParameter(Ljava/lang/String;Ljava/lang/Object;)Lorg/apache/http/params/HttpParams;
    ...
    .line 1786
    invoke-direct {v7, v1}, Lcom/androidquery/callback/AbstractAjaxCallback;->getEncoding(Lorg/apache/http/HttpEntity;)Ljava/lang/String;
    ...
    check-cast v6, Lcom/androidquery/util/PredefinedBAOS;

    invoke-virtual {v6}, Lcom/androidquery/util/PredefinedBAOS;->toByteArray()[B
    ...
    .line 1810
    invoke-static {v14}, Lcom/androidquery/util/AQUtility;->close(Ljava/io/Closeable;)V
    ...
    invoke-direct {v7, v1, v10}, Lcom/androidquery/callback/AbstractAjaxCallback;->toData(Ljava/lang/String;Ljava/io/InputStream;)[B
    ...
    .line 1820
    invoke-virtual {v4, v12}, Lcom/androidquery/callback/AjaxStatus;->code(I)Lcom/androidquery/callback/AjaxStatus;

    move-result-object v4

    invoke-virtual {v4, v13}, Lcom/androidquery/callback/AjaxStatus;->message(Ljava/lang/String;)Lcom/androidquery/callback/AjaxStatus;

    move-result-object v4

    invoke-virtual {v4, v2}, Lcom/androidquery/callback/AjaxStatus;->error(Ljava/lang/String;)Lcom/androidquery/callback/AjaxStatus;

    move-result-object v2

    invoke-virtual {v2, v3}, Lcom/androidquery/callback/AjaxStatus;->redirect(Ljava/lang/String;)Lcom/androidquery/callback/AjaxStatus;
    ...
    invoke-virtual {v1, v15}, Lcom/androidquery/callback/AjaxStatus;->file(Ljava/io/File;)Lcom/androidquery/callback/AjaxStatus;

    move-result-object v1

    invoke-virtual {v1, v8}, Lcom/androidquery/callback/AjaxStatus;->client(Lorg/apache/http/impl/client/DefaultHttpClient;)Lcom/androidquery/callback/AjaxStatus;

    move-result-object v1

    invoke-virtual {v1, v9}, Lcom/androidquery/callback/AjaxStatus;->context(Lorg/apache/http/protocol/HttpContext;)Lcom/androidquery/callback/AjaxStatus;
...
.method private httpMulti(Ljava/lang/String;Ljava/util/Map;Lcom/androidquery/callback/AjaxStatus;)V
    ...
    .line 2046
    iget-object v3, p0, Lcom/androidquery/callback/AbstractAjaxCallback;->proxy:Lorg/apache/http/HttpHost;

    invoke-static {v1, v3}, Lcom/androidquery/util/AQUtility;->debug(Ljava/lang/Object;Ljava/lang/Object;)V
...
.method protected accessFile(Ljava/io/File;Ljava/lang/String;)Ljava/io/File;
    ...
    .line 922
    iget-wide v1, p0, Lcom/androidquery/callback/AbstractAjaxCallback;->expire:J
...
.method protected transform(Ljava/lang/String;[BLcom/androidquery/callback/AjaxStatus;)Ljava/lang/Object;
    ...
    .line 775
    sget-object v2, Lcom/androidquery/callback/AbstractAjaxCallback;->st:Lcom/androidquery/callback/Transformer;
