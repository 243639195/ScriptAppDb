...
.method private readFully(Ljava/io/InputStream;[BI)V
    ...
    invoke-static {p1, p2, v1, p3}, Lnet/lingala/zip4j/util/Zip4jUtil;->readFully(Ljava/io/InputStream;[BII)I
...
.method public readLongLittleEndian([BI)J
    ...
    invoke-direct {p0, v2}, Lnet/lingala/zip4j/util/RawIO;->resetBytes([B)V

    .line 59
    :cond_0
    iget-object v4, p0, Lnet/lingala/zip4j/util/RawIO;->longBuff:[B
    ...
    :goto_0
    invoke-static {p1, p2, v4, v6, v2}, Ljava/lang/System;->arraycopy(Ljava/lang/Object;ILjava/lang/Object;II)V
